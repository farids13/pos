...
extension StorageQueryFilter
  ...
  QueryBuilder<Storage, Storage, QAfterFilterCondition> createdEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Storage, Storage, QAfterFilterCondition> createdGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Storage, Storage, QAfterFilterCondition> createdLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Storage, Storage, QAfterFilterCondition> createdBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension StorageQueryLinks
    on QueryBuilder<Storage, Storage, QFilterCondition> {
  QueryBuilder<Storage, Storage, QAfterFilterCondition> location(
  ...
  QueryBuilder<Storage, Storage, QAfterFilterCondition> locationIsNull() {
    return QueryBuilder.apply(this, (query) {
...
extension StorageQuerySortBy on QueryBuilder<Storage, Storage, QSortBy> {
  QueryBuilder<Storage, Storage, QAfterSortBy> sortByCreated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'created', Sort.asc);
    });
  }

  QueryBuilder<Storage, Storage, QAfterSortBy> sortByCreatedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StorageQuerySortThenBy
  ...
  QueryBuilder<Storage, Storage, QAfterSortBy> thenByCreated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'created', Sort.asc);
    });
  }

  QueryBuilder<Storage, Storage, QAfterSortBy> thenByCreatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'created', Sort.desc);
    });
  }
...
extension StorageQueryWhereDistinct
  ...
  QueryBuilder<Storage, Storage, QDistinct> distinctByCreated() {
    return QueryBuilder.apply(this, (query) {
...
extension StorageQueryProperty
  ...
  QueryBuilder<Storage, DateTime, QQueryOperations> createdProperty() {
    return QueryBuilder.apply(this, (query) {
