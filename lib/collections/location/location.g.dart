...
extension LocationQueryFilter
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> createdEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'created',
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> createdGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> createdLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> createdBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension LocationQueryLinks
    on QueryBuilder<Location, Location, QFilterCondition> {
  QueryBuilder<Location, Location, QAfterFilterCondition> storages(
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> storagesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> storagesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'storages', 0, true, 0, true);
    });
  }

  QueryBuilder<Location, Location, QAfterFilterCondition> storagesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> storagesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension LocationQuerySortBy on QueryBuilder<Location, Location, QSortBy> {
  ...
  QueryBuilder<Location, Location, QAfterSortBy> sortByCreated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'created', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByCreatedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQuerySortThenBy
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByCreated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'created', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByCreatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'created', Sort.desc);
    });
  }
...
extension LocationQueryWhereDistinct
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByCreated() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryProperty
  ...
  QueryBuilder<Location, DateTime, QQueryOperations> createdProperty() {
    return QueryBuilder.apply(this, (query) {
